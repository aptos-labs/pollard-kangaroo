...
mod dlog_without_precomputation {
    ...
    fn test_bsgs_all_values_up_to_11bits() {
        test_solver::<ristretto255_dlog::bsgs::BabyStepGiantStep>(11);
    }

    #[test]
    #[cfg(feature = "bsgs_k")]
    fn test_bsgs_k_all_values_up_to_10bits() {
        test_solver::<ristretto255_dlog::bsgs_k::BabyStepGiantStepK<32>>(10);
        test_solver::<ristretto255_dlog::bsgs_k::BabyStepGiantStepK<64>>(10);
        test_solver::<ristretto255_dlog::bsgs_k::BabyStepGiantStepK<256>>(10);
        test_solver::<ristretto255_dlog::bsgs_k::BabyStepGiantStepK<1024>>(10);
    }

    #[test]
    #[cfg(feature = "tbsgs_k")]
    fn test_tbsgs_k_all_values_up_to_10bits() {
        test_solver::<ristretto255_dlog::tbsgs_k::TruncatedBabyStepGiantStepK<32>>(10);
        test_solver::<ristretto255_dlog::tbsgs_k::TruncatedBabyStepGiantStepK<64>>(10);
        test_solver::<ristretto255_dlog::tbsgs_k::TruncatedBabyStepGiantStepK<256>>(10);
        test_solver::<ristretto255_dlog::tbsgs_k::TruncatedBabyStepGiantStepK<1024>>(10);
    }

    #[test]
    #[cfg(feature = "bl12")]
    fn test_bl12_all_values_up_to_4bits() {
        test_solver::<ristretto255_dlog::bl12::Bl12>(4);
    }
    ...
    fn test_naive_doubled_lookup_all_values_up_to_10bits() {
        ...
        test_solver::<ristretto255_dlog::naive_doubled_lookup::NaiveDoubledLookup>(10);
    }
